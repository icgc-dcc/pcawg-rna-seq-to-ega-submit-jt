...
try:
    r = subprocess.check_output(["ascp", "-QTl", "1500m", "-d", "--src-base="+src_base, encrypted_file, encrypted_md5_file, unencrypted_md5_file, "ega-box-520@fasp.ega.ebi.ac.uk:/"+des_base+"/"])
except Exception, e:
